...
int main()
{
    ...
    while (tt--)
    {
        ...
        long long ans1 = 2 * cnt - cnt % 2;

        //even means, alice shob thik korse, bob just last a ultay diye s=t korse
        //odd means, alice thik kore s==t korse

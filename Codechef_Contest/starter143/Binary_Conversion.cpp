...
int main()
{
    ...
    while (t--)
    {
        ...
        string s, m;
        cin >> s >> m;
        long long cnt = 0, cnt1s = 0, cnt1m = 0;
        ...
        if(cnt1m==cnt1s and (cnt1s==0 or cnt1s==n)){
            cout<<"YES"<<endl;
            continue;
        }

        if (cnt/2 <= k and cnt1m==cnt1s){
            if(n==2){
                 if(s!=m and k%2) cout<<"YES"<<endl;
                 else if(s==m and k%2==0) cout<<"YES"<<endl;
                 else cout<<"NO"<<endl;
            }
            else cout << "YES" << endl;
        }
